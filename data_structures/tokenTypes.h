...
typedef enum {
    ...
    TOKEN_IDENTIFIER, TOKEN_STRING, TOKEN_INTEGER, TOKEN_FLOAT, TOKEN_TYPE_DOUBLE, TOKEN_TYPE_STRING, TOKEN_TYPE_INT, TOKEN_NIL,

    TOKEN_ELSE, TOKEN_FALSE, TOKEN_FUNC, TOKEN_IF, TOKEN_RETURN, TOKEN_TRUE, TOKEN_LET, 
    TOKEN_VAR, TOKEN_WHILE, TOKEN_WITH, TOKEN_WRITE, TOKEN_EOF
} TokenType;
