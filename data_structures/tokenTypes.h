...
typedef enum {
    ...
    TOKEN_IDENTIFIER, TOKEN_STRING, TOKEN_LONG_STRING, TOKEN_INTEGER, TOKEN_FLOAT, TOKEN_TYPE_DOUBLE, TOKEN_TYPE_STRING, TOKEN_TYPE_INT, TOKEN_NIL,TOKEN_QUESTION, TOKEN_DOUBLE_QUESTIONS,
