...
typedef enum {
    ...
    TOKEN_COLON, TOKEN_SLASH, TOKEN_STAR,
    ...
    TOKEN_AND, TOKEN_ELSE, TOKEN_FALSE, TOKEN_FUNC, TOKEN_FOR, TOKEN_IF, TOKEN_NIL, TOKEN_OR, TOKEN_PRINT, TOKEN_RETURN, TOKEN_TRUE, TOKEN_LET, TOKEN_WHILE, TOKEN_EOF
} TokenType;
